...
EMAIL = os.environ.get('EMAIL', 'inozemtsevserge@gmail.com')
DOMAIN = os.environ.get('DOMAIN', 'aitranslator24.com')

RENEW_MINUTE = os.environ.get('RENEW_MINUTE', '0')
RENEW_SECOND = os.environ.get('RENEW_SECOND', '0')
RENEW_HOUR = os.environ.get('RENEW_HOUR', '3')
RENEW_DAY = os.environ.get('RENEW_DAY', '1')
RENEW_DAY_OF_WEEK = os.environ.get('RENEW_DAY_OF_WEEK', '*')
RENEW_MONTH = os.environ.get('RENEW_MONTH', '*/2')
